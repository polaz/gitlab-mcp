...
def build_issue_filter_params(input_model: ListIssuesInput | ListGroupIssuesInput) -> dict[str, Any]:
    ...
    optional_params = {
        ...
        "created_after": lambda x: x.created_after.isoformat() if x.created_after else None,
        "created_before": lambda x: x.created_before.isoformat() if x.created_before else None,
        "updated_after": lambda x: x.updated_after.isoformat() if x.updated_after else None,
        "updated_before": lambda x: x.updated_before.isoformat() if x.updated_before else None,
        "confidential": lambda x: str(x.confidential).lower() if x.confidential is not None else None,
...
def build_issue_create_payload(input_model: CreateIssueInput) -> dict[str, Any]:
    ...
    optional_params = {
        ...
        "merge_request_to_resolve_discussions_of": 
            lambda x: x.merge_request_to_resolve_discussions_of,
    }
...
def build_issue_update_payload(input_model: UpdateIssueInput) -> dict[str, Any]:
    ...
    optional_params = {
        ...
        "assignee_ids": lambda x: x.assignee_ids if x.assignee_ids is not None else None,
        "milestone_id": lambda x: x.milestone_id if x.milestone_id is not None else None,
        ...
        "due_date": lambda x: x.due_date.isoformat() if x.due_date else None,
        "confidential": lambda x: x.confidential if x.confidential is not None else None,
        "discussion_locked": lambda x: x.discussion_locked if x.discussion_locked is not None else None,
    }
